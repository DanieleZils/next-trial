...
export default function Media() {
    ...
    return (
        <div className="relative md:grid md:grid-cols-1 overflow-y-auto">
          <div className='md:fixed inset-0 bg-transparent bg-white z-0'></div> {/* Fixed full-screen black div for large screens */}
              ...
              <div className='md:text-black md:text-left space-y-6 text-center '>
                ...
                {videos.map((video, index) => (
                  <div key={index} 
                    ...
                    <h3 className='text-md md:p-8 md:text-left md:text-black font-bold'>{video.title}</h3>
