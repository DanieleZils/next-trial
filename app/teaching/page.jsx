            ...
            <div className='w-full flex-1 md:text-left text-center sm:order-2'>
                <div className="flex flex-col h-full">
                    <div className='py-8 px-4'>
                        ...
                        <h3 className='text-base md:text-xl font-bold py-4'> Previous Teaching: </h3>
                        ...
                        <br></br><br></br>
                         <h3 className='text-base md:text-lg font-bold'>Faculty at Luzerne Music Center, Senior Session in New York:</h3> 
                        ...
                        <p className='text-base font-bold py-4 '>Core Teaching Artist at Apollo’s Fire-Cleveland Baroque Orchestra, Matteson, IL Side-by-Side Program:</p>
