...
export default function Teaching() {
  ...
  return (
    <main
      ref={contentRef}
      className="relative w-full bg-background min-h-screen transition-opacity duration-[1500ms] opacity-0"
    >
      {/* Philosophy */}
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div className="relative aspect-[3/4] w-full overflow-hidden border border-border lg:sticky lg:top-24">
            <Image
