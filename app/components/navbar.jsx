...
export default function Navbar() {
    ...
    return (
        <div className='navbar fixed z-50 w-full flex justify-between items-center h-20 px-4 md:px-12'>
                    <div className="">
                        <Link className="text-2xl font-bold w-full px-2" href="/">Becca Kasdan</Link>
                    </div>
            <ul className="hidden md:flex xl:text-lg xl:font-semibold sm:text-sm sm:font-semibold sm:text-center">
                <li className="p-8 group">
                    <Link href="/about" className="relative overflow-hidden inline-block">About
                ...
                <li className="p-8 group">
                    <Link href="/voh-cabaret-concert" className="relative overflow-hidden inline-block"> VoH Cabaret Concert
                    <span className="absolute inset-x-0 bottom-0 h-0.5 bg-maroon transform scale-x-0 group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
                    </Link>
                </li>
                <li className="p-8 group">
                    <Link href="/media" className="relative overflow-hidden inline-block">Media
                    <span className="absolute inset-x-0 bottom-0 h-0.5 bg-maroon transform scale-x-0 group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
                    </Link>
                </li>
                <li className="p-8 group">
                    <Link href="/community-engagement" className="relative overflow-hidden inline-block">Community Engagement
                    <span className="absolute inset-x-0 bottom-0 h-0.5 bg-maroon transform scale-x-0 group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
                    </Link>
                </li>
                <li className="p-8 group">
                    <Link href="/teaching" className="relative overflow-hidden inline-block">Teaching
                    <span className="absolute inset-x-0 bottom-0 h-0.5 bg-maroon transform scale-x-0 group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
                    </Link>
                </li>
                <li className="p-8 group">
                    <Link href="/upcoming-events" className="relative overflow-hidden inline-block">Upcoming Events
                    <span className="absolute inset-x-0 bottom-0 h-0.5 bg-maroon transform scale-x-0 group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
                    </Link>
                </li>
                <li className="p-8 group">
                    <Link href="/contact" className="relative overflow-hidden inline-block">Contact
                    <span className="absolute inset-x-0 bottom-0 h-0.5 bg-maroon transform scale-x-0 group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
                    </Link>
                </li>
            </ul>
                ...
                <div className="m-4 p-4">
                    <Link className="text-2xl font-bold" href="/">Becca Kasdan</Link>
                </div>
