    ...
    <main className="relative w-full min-h-screen bg-background pt-20">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative h-72 md:h-auto">
          <div className="md:sticky md:top-20 md:h-[calc(100vh-5rem)] relative h-72">
            <Image
              src={VoH}
        ...
        <div
          ref={contentRef}
          className="px-6 py-14 md:px-14 lg:px-20 md:py-24 transition-opacity duration-[1500ms] opacity-0"
        >
