  ...
  return (
    <main className="relative md:grid md:grid-cols-1 min-h-screen bg-white">
        <div className="relative md:fixed inset-0 top-20 w-full h-64 md:h-full ">
          ...
          <div  ref={contentRef}
          className="relative md:grid md:grid-cols-1 min-h-screen mx-10 md:mt-0 transition-opacity opacity-0 duration-[3s]">
            ...
            <br/> <br/> Becca received her Doctor of Musical Arts in Violin Performance at the University of Illinois at
            ...
            University where she received her MM and BM in Violin Performance.<br/> <br/>
            ...
            collaborating with composers.<br/><br/>
            ...
            Midori discussing community engagement and outreach in the 21st century.<br/><br/>
