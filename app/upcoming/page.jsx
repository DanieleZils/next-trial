    ...
    return (
        <div className="grid md:grid-rows-1 grid-rows-4 min-h-screen">
            ...
            <div className="relative px-6 md:px-24 md:py-24 md:absolute md:inset-0 md:z-10 md:bg-transparent">
                ...
                <p className='md:text-white'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non ligula at enim ornare aliquam. Nulla facilisi. Curabitur quis nibh convallis, porttitor erat sed, fermentum sem. Integer vel lorem dolor. Aenean sed luctus sem.</p>
